 ...
 * @author user
 */
public class GetDataTable3 extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        try{
            ...
            query = "select * from student, takes where student.id = takes.id and grade = 'F'";
            ...
            pw.println("<th style='border: 1px solid black;'>Student Name</th>");
            pw.println("</tr>");
